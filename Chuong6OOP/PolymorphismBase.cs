...
namespace Chuong6OOP.polymorphism
{
    ...
    class Staff 
    {
        ...
        public virtual long SumRealSalary(long profit = 0)
        {
    ...
    class BankAccount
    {
        ...
        public virtual void TakeMonney(long monney, string bankName) { }
        // phương thức nạp tiền
        public virtual void AddMonney(long monney, string bankName) { }
        // chuyển tiền
        public virtual void SendMonney(BankAccount orther, long monney, string bankName) { }
        // thanh toán hóa đơn, dịch vụ
        public virtual long Pay(BankAccount target, long amount, string bankName) => 0;
        // tính tiền lãi cuối kỳ
        public virtual long CalculateInterest() => 0;
        public BankAccount() { }
