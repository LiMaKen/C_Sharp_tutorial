...
{
    string CheckIn(string time);
    string CheckOut(string time);
    string DoWork(string work);
    long SumRealSalary(long profit = 0);
}
abstract class StaffBase : IStaff
{
...
interface IBankAccount
{
    ...
    void TakeMonney(long monney, string bankName);
    // phương thức nạp tiền
    void AddMonney(long monney, string bankName);
    // chuyển tiền
    void SendMonney(BankAccount orther, long monney, string bankName);
